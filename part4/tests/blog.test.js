...
describe('favorite blog', () => {
    ...
    test('of a bigger  list is returned right blog with most likes', () => {
...
describe('most blogs', () => {
    ...
    test('when list has only one blog, return the author of this blog', () => {
        const result = listHelper.mostBlogs(listWithOneBlog);
        expect(result).toEqual({ author: 'Edsger W. Dijkstra', blogs: 1 });
    });

    test('of a bigger  list is returned author with most blogs', () => {
...
describe('most likes', () => {
    ...
    test('of a bigger  list is returned author with most likes', () => {
